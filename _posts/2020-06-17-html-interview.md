...
> 注： 《Javascript高级程序设计》第三版 11-4-1节 298页 && 11-3-3-2节 292页 && 10-1-7节 274页
...
> 注：HTML5规定可以为元素添加非标准的属性，但要添加前缀`data-`，目的是为元素提供与渲染无关的信息，或者提供语义信息。这些属性可以任意添加、任意命名。只要添加`data-`开头即可。例如：
```html
...
if( div.dadtaset.myName ){ //如果有myName值
